 ...
 *
 * For more detail (instruction and wiring diagram), visit https://esp32io.com/tutorials/esp32-ultrasonic-sensor-oled
 */
...
#define TRIG_PIN 32 // ESP32 pin GPIO14 connected to Ultrasonic Sensor's TRIG pin
#define ECHO_PIN 33 // ESP32 pin GPIO27 connected to Ultrasonic Sensor's ECHO pin
